...
function RoomTable({searchText, triggerSearch}) {
    ...
    function DeleteHandle() {
        const URL = `${baseUrl}/admin/api/room/` + idDelete;
    ...
    function handleStatusChange(e) {
        ...
        axios({
            method: 'post',
            url: `${baseUrl}/admin/api/room/${id}/change_status`
        })
            .then(response => {
    ...
    useEffect(() => {
        fetch(`${baseUrl}/admin/api/room?page=${page}&sortField=${'id'}&sortDir=${'asc'}&searchText=${searchText}`)
            .then(res => res.json())
            .then(
                (result) => {
                    setIsLoaded(true);
                        ...
                        rooms.map((room, index) => {
                            return (
                                <tr key={room.id}>
                                    ...
                                    <td className="room_table-column8">
