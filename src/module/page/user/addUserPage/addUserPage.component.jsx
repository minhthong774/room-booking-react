...
function AddUserPage() {
    ...
    const [baselUrl, setBaseUrl] = useBaseUrl();
        ...
        <div className="user-page">
            ...
            <div className="form-container">
                <form className="user-form" onSubmit={handleSubmit} action="#">
                    ...
                    <input className="form-input form-input__last-name" name="LastName" onChange={handleInputChange}
                           type="text"/>

                    <input className="form-radio" onChange={handleInputChange} type="radio" id="nam" name="SEX"
                           value="MALE"/>
                    <label className="form-radio__label">NAM</label>
                    <input className="form-radio" onChange={handleInputChange} type="radio" id="nu" name="SEX"
                           value="FEMALE"/>
                    <label className="form-radio__label">NU</label>
                    <input className="form-radio" onChange={handleInputChange} type="radio" id="other" name="SEX"
                           value="OTHER"/>
                    <label className="form-radio__label">OTHER</label>

                    <label className="form-label">Birthday</label>
                    <input className="form-input form-input__birthday" name="BirthDay" onChange={handleInputChange}
                           type="date"/>
                    ...
                    <input className="form-input form-input__last-name" name="Password" onChange={handleInputChange}
                           type="password"/>

                    <input className="form-radio" onChange={handleInputChange} type="checkbox" name="Host" id="3"
                           value="Admin"/>
                    <label className="form-radio__label">Admin</label>
                    <input className="form-radio" onChange={handleInputChange} type="checkbox" name="Host" id="2"
                           value="User"/>
                    <label className="form-radio__label">User</label>
                    <input className="form-radio" onChange={handleInputChange} type="checkbox" name="Host" id="1"
                           value="Host"/>
                    ...
                    <div className="form-input">
                        <Select link={`${baselUrl}/admin/api/country/select_data/`} name="Country"
                    ...
                    <div className="form-input">
                        <Select link={`${baselUrl}/admin/api/state/select_data_by_country/`}
                    ...
                    <div className="form-input">
                        <Select link={`${baselUrl}/admin/api/city/select_data_by_state/`} parentId={idState}
                    ...
                    <textarea className="form-input_textarea" name="About" onChange={handleInputChange} rows="9"
                              cols="70"></textarea>
