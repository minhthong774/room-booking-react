...
function EditUserPage() {
    ...
    useEffect(() => {
        axios({
            method: 'get',
            url: `${baseUrl}/admin/api/users/${id}`
        ...
        <div className="user-page">
            ...
            <div className="form-container">
                <form className="user-form" onSubmit={handleSubmit} action="#">
                    ...
                    <input className="form-input" name="Avatar" onChange={handleInputChange}
                           accept="image/png, image/jpeg" type="file" width="48" height="48"/>
                    {
                        !user.avatar || preview ? <img className="avatar" src={preview} alt="avatar"/> :
                            <img className="avatar" src={baseUrl + user.avatar} alt="avatar"/>
                    }

                    <label className="form-label">First Name</label>
                    <input className="form-input" name="FirstName" value={user.firstName} onChange={handleInputChange}
                           type="text"/>

                    <label className="form-label">Last Name</label>
                    <input className="form-input form-input__last-name" value={user.lastName} name="LastName"
                           onChange={handleInputChange} type="text"/>

                    <input className="form-radio" onChange={handleInputChange} checked={user.sex === 'MALE'}
                           type="radio" id="nam" name="SEX" value="MALE"/>
                    <label className="form-radio__label">NAM</label>
                    <input className="form-radio" onChange={handleInputChange} checked={user.sex === 'FEMALE'}
                           type="radio" id="nu" name="SEX" value="FEMALE"/>
                    <label className="form-radio__label">NU</label>
                    <input className="form-radio" onChange={handleInputChange} checked={user.sex === 'OTHER'}
                           type="radio" id="other" name="SEX" value="OTHER"/>
                    <label className="form-radio__label">OTHER</label>

                    <label className="form-label">Birthday</label>
                    <input className="form-input form-input__birthday" value={user.birthDay} name="BirthDay"
                           onChange={handleInputChange} type="date"/>

                    <label className="form-label">Email</label>
                    <input className="form-input" name="Email" value={user.email} onChange={handleInputChange}
                           type="text"/>
                    ...
                    <input className="form-input" value={user.phoneNumber} name="PhoneNumber"
                           onChange={handleInputChange} type="text"/>

                    <label className="form-label">Country</label>
                    <div className="form-input">
                        <Select link={`${baseUrl}/admin/api/country/select_data/`} name="Country"
                                curentValue={idCountry} root={true} handleChange={handleInputChange}/>
                    </div>

                    <label className="form-label">State</label>

                    <div className="form-input">
                        <Select link={`${baseUrl}/admin/api/state/select_data_by_country/`}
                                parentId={idCountry} root={false} name="State" curentValue={idState}
                                handleChange={handleInputChange}/>
                    </div>

                    <label className="form-label">City</label>
                    <div className="form-input">
                        <Select link={`${baseUrl}/admin/api/city/select_data_by_state/`} parentId={idState}
                                root={false} name="City" curentValue={idCity} handleChange={handleInputChange}/>
                    </div>
                    ...
                    <textarea className="form-input_textarea" value={user.about} name="About"
                              onChange={handleInputChange} rows="9" cols="70"></textarea>
